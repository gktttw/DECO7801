...
// The handler for rendering different views on different states of 
// Server response
...
export default class FPassword extends Component {
    ...
    constructor(props) {
        super(props)
        this.state = {email: '', reset: false, salt:''}
    }
    ...
    _reset = function() {
        try{
            ...
            return (
            // This render is for users who get in this page firstly
            <View style={styles.dynamicContent}>
                <View style={styles.inputContainer}>
                    <View style={styles.inputContent}>
